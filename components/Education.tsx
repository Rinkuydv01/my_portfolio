        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          >
            ...
            <div className="mt-12 flex items-center justify-between border-t border-white/5 pt-6 font-mono relative z-10">
              ...
              <span className="text-white group-hover:text-[#8A0303] transition-colors duration-300 font-bold text-lg md:text-xl">CGPA - <span className="text-white">8.38</span></span>
            </div>
